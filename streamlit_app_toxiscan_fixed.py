"""
Toxiscan with Fixed PDF and Metabolism Animation
...
from metabolism_animation import create_metabolism_animation_tab
...
def main():
    ...
    <div style="display: flex; align-items: center; gap: 1rem;">
        ...
        <div class="tox21-badge">🎬 Metabolism Animation</div>
    </div>
    ''', unsafe_allow_html=True)
    ...
    if smiles and tox21_models:
        ...
        with tab8:
            ...
            <div class="feature-card">
                ...
                <br><strong>🎬 Animation:</strong> Interactive metabolism site animations available.
            </div>
            """, unsafe_allow_html=True)
        ...
        <div class="feature-card">
            ...
            <ul>
                ...
                <li>🎬 Interactive metabolism site animations</li>
        ...
        <div class="feature-card">
            ...
            <h4>🎬 Metabolism Animation:</h4>
            <p>🎬 New interactive 3D animations showing step-by-step metabolic transformations</p>
